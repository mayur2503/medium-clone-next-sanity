    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className='flex justify-between items-center bg-yellow-400 border-y border-black py-10 lg:p-0'>
        <div className='px-10 space-y-5'>
          <h1 className='text-6xl mx-w-xl font-serif'><span className='underline decoration-black decoration-4'>Medium</span> is the place to read, write and connect</h1>
          <h2>
          ...
          <Link key={post._id} href={`post/${post.slug.current}`}>
            <div className='group border rounded-lg cursor-pointer overflow-hidden'>
              ...
              <div className='flex justify-between p-5 bg-white'>
                ...
                <img  className='h-12 w-12 rounded-full' src={urlFor(post.author.image).url()!} alt='user profile'/>
              </div>
            </div>
          </Link>
        )
